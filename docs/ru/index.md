...
**[Rich Messages приехали, эфемерные ответы стали приватными, Bot API 10.3 раскатился по всему стеку](/ru/changelogs/2026-08-25)** — 31 мая – 25 августа 2026

Telegram **Bot API 10.1–10.3** прошёл через весь стек GramIO: приватные эфемерные ответы, структурированные Rich Messages, рекурсивные загрузки, останавливаемые draft, контексты Communities и подписок, disabled-кнопки, force reply, rich JSX и реалистичные тестовые утилиты. Релизная линейка заканчивается на **gramio v0.14**, когда исправленный набор деклараций `@gramio/types` 10.3.1 появится в npm и JSR.
