...
head:
  - - meta
    - name: description
      content: setChatMenuButton Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: setChatMenuButton, telegram bot api, gramio setChatMenuButton, setChatMenuButton typescript, setChatMenuButton example
---
