...
<ApiParam name="chat_id" type="Integer" description="Unique identifier for the target private chat. If not specified, the bot's default menu button will be changed." />
