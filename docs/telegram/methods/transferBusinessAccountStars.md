...
head:
  - - meta
    - name: description
      content: transferBusinessAccountStars Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: transferBusinessAccountStars, telegram bot api, gramio transferBusinessAccountStars, transferBusinessAccountStars typescript, transferBusinessAccountStars example
---
