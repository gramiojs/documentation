...
head:
  - - meta
    - name: description
      content: removeUserVerification Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: removeUserVerification, telegram bot api, gramio removeUserVerification, removeUserVerification typescript, removeUserVerification example
---
