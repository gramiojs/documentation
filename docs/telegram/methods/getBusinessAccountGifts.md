...
<ApiParam name="exclude_unsaved" type="Boolean" description="Pass *True* to exclude gifts that aren't saved to the account's profile page" />

<ApiParam name="exclude_saved" type="Boolean" description="Pass *True* to exclude gifts that are saved to the account's profile page" />
