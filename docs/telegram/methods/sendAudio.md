...
head:
  - - meta
    - name: description
      content: sendAudio Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: sendAudio, telegram bot api, gramio sendAudio, sendAudio typescript, sendAudio example
---
...
<ApiParam name="caption" type="String" required description="Audio caption, 0-1024 characters after entities parsing" />

<ApiParam name="parse_mode" type="String" required description="Mode for parsing entities in the audio caption. See [formatting options](https://core.telegram.org/bots/api#formatting-options) for more details." />
...
<ApiParam name="duration" type="Integer" required description="Duration of the audio in seconds" />

<ApiParam name="performer" type="String" required description="Performer" />

<ApiParam name="title" type="String" required description="Track name" />
