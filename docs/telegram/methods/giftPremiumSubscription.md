...
<ApiParam name="month_count" type="Integer" required description="Number of months the Telegram Premium subscription will be active for the user; must be one of 3, 6, or 12" />
...
<ApiParam name="text" type="String" required description="Text that will be shown along with the service message about the subscription; 0-128 characters" />
