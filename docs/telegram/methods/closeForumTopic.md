...
head:
  - - meta
    - name: description
      content: closeForumTopic Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: closeForumTopic, telegram bot api, gramio closeForumTopic, closeForumTopic typescript, closeForumTopic example
---
