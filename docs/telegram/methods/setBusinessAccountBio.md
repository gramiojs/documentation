...
head:
  - - meta
    - name: description
      content: setBusinessAccountBio Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: setBusinessAccountBio, telegram bot api, gramio setBusinessAccountBio, setBusinessAccountBio typescript, setBusinessAccountBio example
---
