...
<ApiParam name="star_count" type="Integer" required description="The number of Telegram Stars that must be paid to buy access to the media; 1-25000" :min="1" :max="25000" />
...
<ApiParam name="payload" type="String" required description="Bot-defined paid media payload, 0-128 bytes. This will not be displayed to the user, use it for your internal processes." />

<ApiParam name="caption" type="String" required description="Media caption, 0-1024 characters after entities parsing" />

<ApiParam name="parse_mode" type="String" required description="Mode for parsing entities in the media caption. See [formatting options](https://core.telegram.org/bots/api#formatting-options) for more details." />
