...
head:
  - - meta
    - name: description
      content: reopenGeneralForumTopic Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: reopenGeneralForumTopic, telegram bot api, gramio reopenGeneralForumTopic, reopenGeneralForumTopic typescript, reopenGeneralForumTopic example
---
