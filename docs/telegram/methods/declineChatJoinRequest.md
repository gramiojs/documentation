...
head:
  - - meta
    - name: description
      content: declineChatJoinRequest Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: declineChatJoinRequest, telegram bot api, gramio declineChatJoinRequest, declineChatJoinRequest typescript, declineChatJoinRequest example
---
