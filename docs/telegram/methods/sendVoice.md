...
<ApiParam name="caption" type="String" required description="Voice message caption, 0-1024 characters after entities parsing" />

<ApiParam name="parse_mode" type="String" required description="Mode for parsing entities in the voice message caption. See [formatting options](https://core.telegram.org/bots/api#formatting-options) for more details." />
...
<ApiParam name="duration" type="Integer" required description="Duration of the voice message in seconds" />
