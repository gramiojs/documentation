...
head:
  - - meta
    - name: description
      content: hideGeneralForumTopic Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: hideGeneralForumTopic, telegram bot api, gramio hideGeneralForumTopic, hideGeneralForumTopic typescript, hideGeneralForumTopic example
---
