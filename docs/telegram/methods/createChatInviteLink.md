...
head:
  - - meta
    - name: description
      content: createChatInviteLink Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: createChatInviteLink, telegram bot api, gramio createChatInviteLink, createChatInviteLink typescript, createChatInviteLink example
---
