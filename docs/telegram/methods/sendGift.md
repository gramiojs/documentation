...
<ApiParam name="chat_id" type="Integer | String" description="Required if *user\_id* is not specified. Unique identifier for the chat or username of the channel (in the format `@username`) that will receive the gift." />
