...
head:
  - - meta
    - name: description
      content: getMyDescription Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: getMyDescription, telegram bot api, gramio getMyDescription, getMyDescription typescript, getMyDescription example
---
