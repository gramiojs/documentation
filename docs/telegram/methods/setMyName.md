...
head:
  - - meta
    - name: description
      content: setMyName Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: setMyName, telegram bot api, gramio setMyName, setMyName typescript, setMyName example
---
