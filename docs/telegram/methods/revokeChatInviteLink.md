...
<ApiParam name="chat_id" type="Integer | String" required description="Unique identifier of the target chat or username of the target channel in the format `@username`" />
