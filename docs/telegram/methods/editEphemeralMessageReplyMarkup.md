---
title: editEphemeralMessageReplyMarkup — Telegram Bot API | GramIO
head:
  - - meta
    - name: description
      content: editEphemeralMessageReplyMarkup Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: editEphemeralMessageReplyMarkup, telegram bot api, gramio editEphemeralMessageReplyMarkup, editEphemeralMessageReplyMarkup typescript, editEphemeralMessageReplyMarkup example
---
...
<div class="api-badge-row">
  ...
  <a class="api-badge official" href="https://core.telegram.org/bots/api#editephemeralmessagereplymarkup" target="_blank" rel="noopener">Official docs ↗</a>
</div>
