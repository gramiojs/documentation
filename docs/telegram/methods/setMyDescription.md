...
head:
  - - meta
    - name: description
      content: setMyDescription Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: setMyDescription, telegram bot api, gramio setMyDescription, setMyDescription typescript, setMyDescription example
---
