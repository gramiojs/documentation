...
head:
  - - meta
    - name: description
      content: removeChatVerification Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: removeChatVerification, telegram bot api, gramio removeChatVerification, removeChatVerification typescript, removeChatVerification example
---
