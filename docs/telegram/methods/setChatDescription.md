...
head:
  - - meta
    - name: description
      content: setChatDescription Telegram Bot API method with GramIO TypeScript examples. Complete parameter reference and usage guide.
  - - meta
    - name: keywords
      content: setChatDescription, telegram bot api, gramio setChatDescription, setChatDescription typescript, setChatDescription example
---
