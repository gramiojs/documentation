...
<ApiParam name="video_height" type="Integer" description="*Optional*. Video height" />

<ApiParam name="video_duration" type="Integer" description="*Optional*. Video duration in seconds" />
