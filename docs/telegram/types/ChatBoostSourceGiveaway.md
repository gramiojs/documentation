...
<ApiParam name="source" type="String" required description="Source of the boost, always “giveaway”" />
...
<ApiParam name="user" type="User" description="_Optional_. User that won the prize in the giveaway if any; for Telegram Premium giveaways only" />
...
<ApiParam name="is_unclaimed" type="Boolean" description="_Optional_. _True_, if the giveaway was completed, but there was no user to win the prize" />
