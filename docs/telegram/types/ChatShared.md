...
<ApiParam name="title" type="String" description="*Optional*. Title of the chat, if the title was requested by the bot." />

<ApiParam name="username" type="String" description="*Optional*. Username of the chat, if the username was requested by the bot and available." />
