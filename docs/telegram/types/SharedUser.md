...
<ApiParam name="first_name" type="String" description="_Optional_. First name of the user, if the name was requested by the bot" />

<ApiParam name="last_name" type="String" description="_Optional_. Last name of the user, if the name was requested by the bot" />

<ApiParam name="username" type="String" description="_Optional_. Username of the user, if the username was requested by the bot" />
