...
<ApiParam name="type" type="String" required description="Type of the result, must be *animation*" constValue="animation" />
...
<ApiParam name="caption" type="String" description="*Optional*. Caption of the animation to be sent, 0-1024 characters after entities parsing" :minLen="0" :maxLen="1024" semanticType="formattable" docsLink="/formatting" />
