...
<ApiParam name="currency" type="String" required description="Currency in which the payment was made. Currently, one of &quot;XTR&quot; for Telegram Stars or &quot;TON&quot; for TON grams." :enumValues='["XTR","TON"]' />

<ApiParam name="amount" type="Integer" description="*Optional*. The amount of the currency that was received by the channel in nanograms; for payments in TON grams only" />
