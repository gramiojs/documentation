...
<ApiParam name="source" type="String" required description="Error source, must be _reverse\_side_" />

<ApiParam name="type" type="String" required description="The section of the user's Telegram Passport which has the issue, one of “driver\_license”, “identity\_card”" />
