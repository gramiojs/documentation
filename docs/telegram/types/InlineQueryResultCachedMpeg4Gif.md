---
title: InlineQueryResultCachedMpeg4Gif — Telegram Bot API Types | GramIO
head:
  - - meta
    - name: description
      content: InlineQueryResultCachedMpeg4Gif Telegram Bot API type reference. All fields with TypeScript types and GramIO usage examples.
  - - meta
    - name: keywords
      content: InlineQueryResultCachedMpeg4Gif, telegram bot api types, gramio InlineQueryResultCachedMpeg4Gif, InlineQueryResultCachedMpeg4Gif object, InlineQueryResultCachedMpeg4Gif typescript
---
...
<div class="api-badge-row">
  <a class="api-badge official" href="https://core.telegram.org/bots/api#inlinequeryresultcachedmpeg4gif" target="_blank" rel="noopener">Official docs ↗</a>
</div>
...
<ApiParam name="type" type="String" required description="Type of the result, must be *mpeg4\_gif*" constValue="mpeg4_gif" />

<ApiParam name="id" type="String" required description="Unique identifier for this result, 1-64 bytes" />

<ApiParam name="mpeg4_file_id" type="String" required description="A valid file identifier for the MPEG4 file" />

<ApiParam name="title" type="String" description="*Optional*. Title for the result" />

<ApiParam name="caption" type="String" description="*Optional*. Caption of the MPEG-4 file to be sent, 0-1024 characters after entities parsing" :minLen="0" :maxLen="1024" semanticType="formattable" docsLink="/formatting" />
