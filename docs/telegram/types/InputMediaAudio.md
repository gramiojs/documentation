...
<ApiParam name="type" type="String" required description="Type of the media, must be *audio*" constValue="audio" />
...
<ApiParam name="caption" type="String" description="*Optional*. Caption of the audio to be sent, 0-1024 characters after entities parsing" :minLen="0" :maxLen="1024" semanticType="formattable" docsLink="/formatting" />
