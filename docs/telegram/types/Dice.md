---
title: Dice — Telegram Bot API Types | GramIO
head:
  - - meta
    - name: description
      content: Dice Telegram Bot API type reference. All fields with TypeScript types and GramIO usage examples.
  - - meta
    - name: keywords
      content: Dice, telegram bot api types, gramio Dice, Dice object, Dice typescript
---
...
<div class="api-badge-row">
  <a class="api-badge official" href="https://core.telegram.org/bots/api#dice" target="_blank" rel="noopener">Official docs ↗</a>
</div>
